    ...
    <section class="about-section">
        ...
        <div class="row">
            <div class="about-content">
                ...
                <div class="about-content-text">
                    <p>Hẻm trà chanh.</p>
                    <p>Khách hàng có thể tận hưởng hương vị của Hemtrachanh tại quán hoặc order mọi món về tận nhà.</p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="about-article">
                <h3>Nước uống tuyệt hảo</h3>
            </div>
        </div>

        <div class="row gallery">
            <div class="wrapper">
                <img src="../assets/images/dessert/dessert-3.png" alt="">
                <img src="../assets/images/dessert/dessert-7.jpg" alt="">
                <img src="../assets/images/dessert/dessert-7.png" alt="">
            </div>
        </div>
    </section>
</template>
